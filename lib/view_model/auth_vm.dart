// ignore_for_file: avoid_single_cascade_in_expression_statements, avoid_print, prefer_const_constructors, unnecessary_import, use_build_context_synchronously
...
class AuthVm extends ChangeNotifier {
  ...
  Future<void> login(BuildContext context) async {
    ...
    if (result.success == true) {
      await getIt.get<LocalStorageService>().setName(result.user?.name);
